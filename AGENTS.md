...
- Drift SQLite — new `workspace_compaction_settings` table with per‑workspace override columns; `messages` metadata JSON for compaction summaries and ranges (011-agent-compaction-settings)
