...
mixin _$WorkspaceModelSelectionEntity {
 ...
 String get id; String get modelId; DateTime get createdAt; DateTime get updatedAt; String get modelConnectionId; String? get modelName; List<String> get modalitiesInput; List<String> get modalitiesOutput; bool get supportsReasoning; List<ReasoningOption> get reasoningOptions; bool get supportsToolCalls;
...
int get hashCode {
  final _this = this as WorkspaceModelSelectionEntity;
  return Object.hash(runtimeType,_this.id,_this.modelId,_this.createdAt,_this.updatedAt,_this.modelConnectionId,_this.modelName,const DeepCollectionEquality().hash(_this.modalitiesInput),const DeepCollectionEquality().hash(_this.modalitiesOutput),_this.supportsReasoning,const DeepCollectionEquality().hash(_this.reasoningOptions),_this.supportsToolCalls);
}

@override
String toString() {
  final _this = this as WorkspaceModelSelectionEntity;
  return 'WorkspaceModelSelectionEntity(id: ${_this.id}, modelId: ${_this.modelId}, createdAt: ${_this.createdAt}, updatedAt: ${_this.updatedAt}, modelConnectionId: ${_this.modelConnectionId}, modelName: ${_this.modelName}, modalitiesInput: ${_this.modalitiesInput}, modalitiesOutput: ${_this.modalitiesOutput}, supportsReasoning: ${_this.supportsReasoning}, reasoningOptions: ${_this.reasoningOptions}, supportsToolCalls: ${_this.supportsToolCalls})';
}
...
@useResult
$Res call({
 String id, String modelId, DateTime createdAt, DateTime updatedAt, String modelConnectionId, String? modelName, List<String> modalitiesInput, List<String> modalitiesOutput, bool supportsReasoning, List<ReasoningOption> reasoningOptions, bool supportsToolCalls
});
...
as String?,modalitiesInput: null == modalitiesInput ? _self.modalitiesInput : modalitiesInput // ignore: cast_nullable_to_non_nullable
as List<String>,modalitiesOutput: null == modalitiesOutput ? _self.modalitiesOutput : modalitiesOutput // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String modelId,  DateTime createdAt,  DateTime updatedAt,  String modelConnectionId,  String? modelName,  List<String> modalitiesInput,  List<String> modalitiesOutput,  bool supportsReasoning,  List<ReasoningOption> reasoningOptions,  bool supportsToolCalls)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WorkspaceModelSelectionEntity() when $default != null:
return $default(_that.id,_that.modelId,_that.createdAt,_that.updatedAt,_that.modelConnectionId,_that.modelName,_that.modalitiesInput,_that.modalitiesOutput,_that.supportsReasoning,_that.reasoningOptions,_that.supportsToolCalls);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String modelId,  DateTime createdAt,  DateTime updatedAt,  String modelConnectionId,  String? modelName,  List<String> modalitiesInput,  List<String> modalitiesOutput,  bool supportsReasoning,  List<ReasoningOption> reasoningOptions,  bool supportsToolCalls)  $default,) {final _that = this;
switch (_that) {
case _WorkspaceModelSelectionEntity():
return $default(_that.id,_that.modelId,_that.createdAt,_that.updatedAt,_that.modelConnectionId,_that.modelName,_that.modalitiesInput,_that.modalitiesOutput,_that.supportsReasoning,_that.reasoningOptions,_that.supportsToolCalls);case _:
  throw StateError('Unexpected subclass');
...
class _WorkspaceModelSelectionEntity implements WorkspaceModelSelectionEntity {
  const _WorkspaceModelSelectionEntity({required this.id, required this.modelId, required this.createdAt, required this.updatedAt, required this.modelConnectionId, this.modelName,  List<String> modalitiesInput = const [],  List<String> modalitiesOutput = const [], this.supportsReasoning = false,  List<ReasoningOption> reasoningOptions = const [], this.supportsToolCalls = true}): _modalitiesInput = modalitiesInput,_modalitiesOutput = modalitiesOutput,_reasoningOptions = reasoningOptions;
...
@override@JsonKey() List<String> get modalitiesInput {
 ...
 final  List<String> _modalitiesOutput;
@override@JsonKey() List<String> get modalitiesOutput {
  if (_modalitiesOutput is EqualUnmodifiableListView) return _modalitiesOutput;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_modalitiesOutput);
}

@override@JsonKey() final  bool supportsReasoning;
 final  List<ReasoningOption> _reasoningOptions;
@override@JsonKey() List<ReasoningOption> get reasoningOptions {
  if (_reasoningOptions is EqualUnmodifiableListView) return _reasoningOptions;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_reasoningOptions);
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,modelId,createdAt,updatedAt,modelConnectionId,modelName,const DeepCollectionEquality().hash(_modalitiesInput),const DeepCollectionEquality().hash(_modalitiesOutput),supportsReasoning,const DeepCollectionEquality().hash(_reasoningOptions),supportsToolCalls);
}
...
as DateTime,modelConnectionId: null == modelConnectionId ? _self.modelConnectionId : modelConnectionId // ignore: cast_nullable_to_non_nullable
as String,modelName: freezed == modelName ? _self.modelName : modelName // ignore: cast_nullable_to_non_nullable
as String?,modalitiesInput: null == modalitiesInput ? _self._modalitiesInput : modalitiesInput // ignore: cast_nullable_to_non_nullable
as List<String>,modalitiesOutput: null == modalitiesOutput ? _self._modalitiesOutput : modalitiesOutput // ignore: cast_nullable_to_non_nullable
as List<String>,supportsReasoning: null == supportsReasoning ? _self.supportsReasoning : supportsReasoning // ignore: cast_nullable_to_non_nullable
