...
/// Unique identifier for the conversation.
 ...
 DateTime get updatedAt;/// Server revision for optimistic cloud mutations.
 int get revision;/// ID of the AI model used for this conversation.
 String? get modelId;/// ID of the selected agent used for this conversation.
 String? get agentId;/// Parent conversation id for hidden child/sub-agent conversations.
 String? get parentConversationId;/// Source conversation id for a reference-backed fork.
...
int get hashCode {
  final _this = this as ConversationEntity;
  return Object.hash(runtimeType,_this.id,_this.title,_this.workspaceId,_this.isPinned,_this.createdAt,_this.updatedAt,_this.revision,_this.modelId,_this.agentId,_this.parentConversationId,_this.forkSourceConversationId,_this.forkSourceTitle,_this.forkThroughMessageId,_this.forkMaterializedAt);
}

@override
String toString() {
  final _this = this as ConversationEntity;
  return 'ConversationEntity(id: ${_this.id}, title: ${_this.title}, workspaceId: ${_this.workspaceId}, isPinned: ${_this.isPinned}, createdAt: ${_this.createdAt}, updatedAt: ${_this.updatedAt}, revision: ${_this.revision}, modelId: ${_this.modelId}, agentId: ${_this.agentId}, parentConversationId: ${_this.parentConversationId}, forkSourceConversationId: ${_this.forkSourceConversationId}, forkSourceTitle: ${_this.forkSourceTitle}, forkThroughMessageId: ${_this.forkThroughMessageId}, forkMaterializedAt: ${_this.forkMaterializedAt})';
}
...
@useResult
$Res call({
 String id, String title, String workspaceId, bool isPinned, DateTime createdAt, DateTime updatedAt, int revision, String? modelId, String? agentId, String? parentConversationId, String? forkSourceConversationId, String? forkSourceTitle, String? forkThroughMessageId, DateTime? forkMaterializedAt
});
...
as String?,parentConversationId: freezed == parentConversationId ? _self.parentConversationId : parentConversationId // ignore: cast_nullable_to_non_nullable
as String?,forkSourceConversationId: freezed == forkSourceConversationId ? _self.forkSourceConversationId : forkSourceConversationId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String workspaceId,  bool isPinned,  DateTime createdAt,  DateTime updatedAt,  int revision,  String? modelId,  String? agentId,  String? parentConversationId,  String? forkSourceConversationId,  String? forkSourceTitle,  String? forkThroughMessageId,  DateTime? forkMaterializedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ConversationEntity() when $default != null:
return $default(_that.id,_that.title,_that.workspaceId,_that.isPinned,_that.createdAt,_that.updatedAt,_that.revision,_that.modelId,_that.agentId,_that.parentConversationId,_that.forkSourceConversationId,_that.forkSourceTitle,_that.forkThroughMessageId,_that.forkMaterializedAt);case _:
  return orElse();
...
class _ConversationEntity extends ConversationEntity {
  const _ConversationEntity({required this.id, required this.title, required this.workspaceId, required this.isPinned, required this.createdAt, required this.updatedAt, this.revision = 0, this.modelId, this.agentId, this.parentConversationId, this.forkSourceConversationId, this.forkSourceTitle, this.forkThroughMessageId, this.forkMaterializedAt}): super._();
...
@override final  String? parentConversationId;
/// Source conversation id for a reference-backed fork.
@override final  String? forkSourceConversationId;
/// Source title captured when the fork was created.
@override final  String? forkSourceTitle;
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,title,workspaceId,isPinned,createdAt,updatedAt,revision,modelId,agentId,parentConversationId,forkSourceConversationId,forkSourceTitle,forkThroughMessageId,forkMaterializedAt);
}

@override
String toString() {
    return 'ConversationEntity(id: $id, title: $title, workspaceId: $workspaceId, isPinned: $isPinned, createdAt: $createdAt, updatedAt: $updatedAt, revision: $revision, modelId: $modelId, agentId: $agentId, parentConversationId: $parentConversationId, forkSourceConversationId: $forkSourceConversationId, forkSourceTitle: $forkSourceTitle, forkThroughMessageId: $forkThroughMessageId, forkMaterializedAt: $forkMaterializedAt)';
}
...
/// Human-readable title of the conversation.
 ...
 String? get modelId;/// ID of the selected agent used for this conversation.
 String? get agentId;/// Parent conversation id for hidden child/sub-agent conversations.
 String? get parentConversationId;/// Whether this conversation is pinned.
 bool? get isPinned;
...
@useResult
$Res call({
 String title, String workspaceId, String? modelId, String? agentId, String? parentConversationId, bool? isPinned
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  String workspaceId,  String? modelId,  String? agentId,  String? parentConversationId,  bool? isPinned)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ConversationToCreate() when $default != null:
return $default(_that.title,_that.workspaceId,_that.modelId,_that.agentId,_that.parentConversationId,_that.isPinned);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  String workspaceId,  String? modelId,  String? agentId,  String? parentConversationId,  bool? isPinned)  $default,) {final _that = this;
switch (_that) {
case _ConversationToCreate():
return $default(_that.title,_that.workspaceId,_that.modelId,_that.agentId,_that.parentConversationId,_that.isPinned);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  String workspaceId,  String? modelId,  String? agentId,  String? parentConversationId,  bool? isPinned)?  $default,) {final _that = this;
switch (_that) {
case _ConversationToCreate() when $default != null:
return $default(_that.title,_that.workspaceId,_that.modelId,_that.agentId,_that.parentConversationId,_that.isPinned);case _:
  return null;
...
class _ConversationToCreate extends ConversationToCreate {
  const _ConversationToCreate({required this.title, required this.workspaceId, this.modelId, this.agentId, this.parentConversationId, this.isPinned}): super._();
...
/// Create a copy of ConversationToCreate
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? workspaceId = null,Object? modelId = freezed,Object? agentId = freezed,Object? parentConversationId = freezed,Object? isPinned = freezed,}) {
...
/// Human-readable title of the conversation.
 ...
 String? get modelId;/// ID of the selected agent used for this conversation.
 String? get agentId;/// Clears [agentId]. Nullable Freezed fields cannot express null set.
 bool get clearAgent;/// Whether this conversation is pinned.
 bool? get isPinned;
/// Create a copy of ConversationPatch
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ConversationPatchCopyWith<ConversationPatch> get copyWith => _$ConversationPatchCopyWithImpl<ConversationPatch>(this as ConversationPatch, _$identity);
...
/// @nodoc
abstract mixin class $ConversationPatchCopyWith<$Res>  {
...
@useResult
$Res call({
 String? title, String? modelId, String? agentId, bool clearAgent, bool? isPinned
});
...
/// @nodoc
class _$ConversationPatchCopyWithImpl<$Res>
    implements $ConversationPatchCopyWith<$Res> {
  _$ConversationPatchCopyWithImpl(this._self, this._then);

  final ConversationPatch _self;
  final $Res Function(ConversationPatch) _then;
...
as String?,modelId: freezed == modelId ? _self.modelId : modelId // ignore: cast_nullable_to_non_nullable
as String?,agentId: freezed == agentId ? _self.agentId : agentId // ignore: cast_nullable_to_non_nullable
as String?,clearAgent: null == clearAgent ? _self.clearAgent : clearAgent // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [ConversationPatch].
extension ConversationPatchPatterns on ConversationPatch {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ConversationPatch value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ConversationPatch value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ConversationPatch value)?  $default,){
final _that = this;
switch (_that) {
case _ConversationPatch() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? title,  String? modelId,  String? agentId,  bool clearAgent,  bool? isPinned)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ConversationPatch() when $default != null:
return $default(_that.title,_that.modelId,_that.agentId,_that.clearAgent,_that.isPinned);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? title,  String? modelId,  String? agentId,  bool clearAgent,  bool? isPinned)  $default,) {final _that = this;
switch (_that) {
case _ConversationPatch():
return $default(_that.title,_that.modelId,_that.agentId,_that.clearAgent,_that.isPinned);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? title,  String? modelId,  String? agentId,  bool clearAgent,  bool? isPinned)?  $default,) {final _that = this;
switch (_that) {
case _ConversationPatch() when $default != null:
return $default(_that.title,_that.modelId,_that.agentId,_that.clearAgent,_that.isPinned);case _:
  return null;
...
class _ConversationPatch extends ConversationPatch {
  const _ConversationPatch({this.title, this.modelId, this.agentId, this.clearAgent = false, this.isPinned}): super._();
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$ConversationPatchCopyWith<_ConversationPatch> get copyWith => __$ConversationPatchCopyWithImpl<_ConversationPatch>(this, _$identity);
...
/// @nodoc
abstract mixin class _$ConversationPatchCopyWith<$Res> implements $ConversationPatchCopyWith<$Res> {
...
/// @nodoc
class __$ConversationPatchCopyWithImpl<$Res>
    implements _$ConversationPatchCopyWith<$Res> {
  __$ConversationPatchCopyWithImpl(this._self, this._then);

  final _ConversationPatch _self;
  final $Res Function(_ConversationPatch) _then;

/// Create a copy of ConversationPatch
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = freezed,Object? modelId = freezed,Object? agentId = freezed,Object? clearAgent = null,Object? isPinned = freezed,}) {
