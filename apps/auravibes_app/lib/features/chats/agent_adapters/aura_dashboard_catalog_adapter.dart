...
final _builders = <String, _DashboardBuilder>{
  'Progress': _progress,
  'Badge': _badge,
  'Avatar': _avatar,
...
Widget _boundData(CatalogItemContext context, _DashboardBuilder builder) {
...
Widget _progress(CatalogItemContext context, Map<String, Object?> data) {
...
Widget _badge(CatalogItemContext _, Map<String, Object?> data) =>
    AuraBadge.text(
...
Widget _avatar(CatalogItemContext _, Map<String, Object?> data) {
...
Widget _avatarGroup(CatalogItemContext context, Map<String, Object?> data) {
...
Widget _table(CatalogItemContext _, Map<String, Object?> data) {
  final columns = (data['columns']! as List)
      .map((value) => value is Map ? value : <Object?, Object?>{'label': value})
      .toList(growable: false);
  final rows = (data['rows']! as List)
      .map((value) => value is Map ? value : <Object?, Object?>{'cells': value})
      .toList(growable: false);
  ...
  return AuraTable(
    ...
    sortableColumns: [for (final column in columns) column['sortable'] == true],
...
Widget _loading(CatalogItemContext _, Map<String, Object?> data) {
  final label = data['label']! as String;
...
Widget _chart(CatalogItemContext _, Map<String, Object?> data) {
...
Widget _animated(CatalogItemContext context, Map<String, Object?> data) =>
    AuraAnimatedContent(
      child: KeyedSubtree(
        key: ValueKey(
...
AuraTint? _nullableTone(Object? value) => value is String ? _tone(value) : null;
