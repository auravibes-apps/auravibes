...
mixin _$ToolsGroupWithTools {
 ...
 ToolsGroupEntity? get group; List<WorkspaceToolEntity> get tools; DefaultToolGroupType? get defaultGroupType; McpConnectionState? get mcpConnectionState;
...
@useResult
$Res call({
 ToolsGroupEntity? group, List<WorkspaceToolEntity> tools, DefaultToolGroupType? defaultGroupType, McpConnectionState? mcpConnectionState
});
...
@pragma('vm:prefer-inline') @override $Res call({Object? group = freezed,Object? tools = null,Object? defaultGroupType = freezed,Object? mcpConnectionState = freezed,}) {
  return _then(ToolsGroupWithTools(
...
as List<WorkspaceToolEntity>,defaultGroupType: freezed == defaultGroupType ? _self.defaultGroupType : defaultGroupType // ignore: cast_nullable_to_non_nullable
as DefaultToolGroupType?,mcpConnectionState: freezed == mcpConnectionState ? _self.mcpConnectionState : mcpConnectionState // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ToolsGroupEntity? group,  List<WorkspaceToolEntity> tools,  DefaultToolGroupType? defaultGroupType,  McpConnectionState? mcpConnectionState)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ToolsGroupWithTools() when $default != null:
return $default(_that.group,_that.tools,_that.defaultGroupType,_that.mcpConnectionState);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ToolsGroupEntity? group,  List<WorkspaceToolEntity> tools,  DefaultToolGroupType? defaultGroupType,  McpConnectionState? mcpConnectionState)  $default,) {final _that = this;
switch (_that) {
case _ToolsGroupWithTools():
return $default(_that.group,_that.tools,_that.defaultGroupType,_that.mcpConnectionState);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ToolsGroupEntity? group,  List<WorkspaceToolEntity> tools,  DefaultToolGroupType? defaultGroupType,  McpConnectionState? mcpConnectionState)?  $default,) {final _that = this;
switch (_that) {
case _ToolsGroupWithTools() when $default != null:
return $default(_that.group,_that.tools,_that.defaultGroupType,_that.mcpConnectionState);case _:
  return null;
...
class _ToolsGroupWithTools extends ToolsGroupWithTools {
  const _ToolsGroupWithTools({required this.group, required  List<WorkspaceToolEntity> tools, this.defaultGroupType, this.mcpConnectionState}): assert(group != null || defaultGroupType != null),assert(group == null || defaultGroupType == null),_tools = tools,super._();
...
@override final  DefaultToolGroupType? defaultGroupType;
...
/// Create a copy of ToolsGroupWithTools
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? group = freezed,Object? tools = null,Object? defaultGroupType = freezed,Object? mcpConnectionState = freezed,}) {
