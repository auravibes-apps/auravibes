...
/// A reusable text input widget backed by Riverpod providers
/// and localized UI strings.
///
/// This widget builds an [AuraInput] whose text is initialized
/// from and kept in sync
/// with the given [value] provider.
/// Any user changes are forwarded to the callback exposed
/// by the [onChanged] provider.
///
/// The `labelLocaleKey`, `placeholderLocaleKey`,
/// and optional [hintLocaleKey] are looked up via [TextLocale]
/// to display localized label, placeholder, and hint
