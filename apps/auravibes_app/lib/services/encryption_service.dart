...
class EncryptionService {
  ...
  static const int _minimumEncryptedBytesLength = _nonceLength + _macLength;
  ...
  Future<String> decrypt(String encryptedBase64) async {
    final key = await _keyManager.getOrCreateSecretKey();
    final combined = _decodeCombinedCiphertext(encryptedBase64);
  ...
  Uint8List _decodeCombinedCiphertext(String encryptedBase64) {
    final combined = base64Decode(encryptedBase64);
    if (combined.length < _minimumEncryptedBytesLength) {
