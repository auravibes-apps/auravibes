...
// in auravibes_app/test/domain/usecases/tools/execution/grant_tool_permission_usecase_test.dart.
...
/// A class which mocks [BatchExecuteToolsUseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockBatchExecuteToolsUseCase extends _i1.Mock
    implements _i13.BatchExecuteToolsUseCase {
  MockBatchExecuteToolsUseCase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<List<_i13.BatchToolResult>> call({
    required List<_i2.ToolToCall>? tools,
    required String? messageId,
      ...
      (super.noSuchMethod(
            ...
            returnValue: _i5.Future<List<_i13.BatchToolResult>>.value(
              <_i13.BatchToolResult>[],
            ),
          )
          as _i5.Future<List<_i13.BatchToolResult>>);
}

/// A class which mocks [UpdateMessageMetadataUseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockUpdateMessageMetadataUseCase extends _i1.Mock
    implements _i14.UpdateMessageMetadataUseCase {
  MockUpdateMessageMetadataUseCase() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i5.Future<void> call({
    required String? messageId,
    required List<_i14.ToolResultUpdate>? updates,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#call, [], {
              #messageId: messageId,
