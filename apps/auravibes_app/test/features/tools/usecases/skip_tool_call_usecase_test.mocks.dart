...
// in auravibes_app/test/features/tools/usecases/skip_tool_call_usecase_test.dart.
...
class MockMessageRepository extends _i1.Mock implements _i3.MessageRepository {
  ...
  @override
  _i4.Stream<List<_i2.MessageEntity>> watchMessagesByConversation(
    String? conversationId,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<_i2.MessageEntity> patchMessage(
    String? id,
...
class MockResumeConversationIfReadyUsecase extends _i1.Mock
    implements _i6.ResumeConversationIfReadyUsecase {
  MockResumeConversationIfReadyUsecase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<void> call({required String? messageId}) =>
      (super.noSuchMethod(
