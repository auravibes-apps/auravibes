...
void main() {
  group('EncryptionService', () {
    ...
    test('decrypt rejects payload shorter than nonce and mac', () async {
      final malformedBase64 = base64Encode(
        List<int>.generate(27, (index) => index),
      );

      await expectLater(
        () => service.decrypt(malformedBase64),
        throwsA(
