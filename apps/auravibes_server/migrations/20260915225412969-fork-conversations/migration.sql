...
-- ACTION ALTER TABLE
--
ALTER TABLE "conversation" ADD COLUMN "forkSourceConversationId" text;
ALTER TABLE "conversation" ADD COLUMN "forkSourceTitle" text;
ALTER TABLE "conversation" ADD COLUMN "forkThroughMessageId" text;
ALTER TABLE "conversation" ADD COLUMN "forkMaterializedAt" timestamp without time zone;
