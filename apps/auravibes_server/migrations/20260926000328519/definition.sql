...
CREATE TABLE "conversation" (
    ...
    "modelId" text,
    "agentId" text,
    "reasoningConfigJson" text,
    "parentConversationStableId" text,
    "revision" bigint NOT NULL,
    "projectionRevision" bigint NOT NULL DEFAULT 1,
    "eventSequence" bigint NOT NULL DEFAULT 0,
    "executionState" text NOT NULL DEFAULT 'idle'::text,
    "activeExecutionId" bigint,
    "activeCompactionCheckpointId" text,
    "createdAt" timestamp without time zone NOT NULL,
    "updatedAt" timestamp without time zone NOT NULL,
    "deletedAt" timestamp without time zone,
    "forkSourceConversationId" text,
    "forkSourceTitle" text,
    "forkThroughMessageId" text,
    "forkMaterializedAt" timestamp without time zone
);
...
CREATE INDEX "conversation_fork_source_idx" ON "conversation" USING btree ("workspaceId", "forkSourceConversationId");

--
-- Class ConversationEvent as table conversation_event
--
...
--
-- Class ConversationExecution as table conversation_execution
--
...
CREATE TABLE "conversation_message" (
    ...
    "metadataJson" text,
    "pendingOrder" bigint,
    "pendingAt" timestamp without time zone,
...
--
-- Class RecentModelSelection as table recent_model_selection
--
...
--
-- Class SkillResource as table skill_resource
--
...
--
-- Foreign relations for "conversation_event" table
--
...
--
-- Foreign relations for "conversation_execution" table
--
...
--
-- Foreign relations for "recent_model_selection" table
--
...
--
-- Foreign relations for "skill_resource" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('auravibes', '20260926000328519', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260926000328519', "timestamp" = now();
