...
import '../features/conversations/workers/conversation_worker.dart' as _i4;
import '../features/model_connections/workers/model_catalog_sync_worker.dart'
    as _i5;
import '../features/objects/object_cleanup_service.dart' as _i6;
...
class FutureCalls extends _i1.FutureCallDispatch<_FutureCallRef> {
  ...
  void initialize(
    ...
    var registeredFutureCalls = <String, _i1.FutureCall>{
      'ConversationWorkerInvokeFutureCall':
          ConversationWorkerInvokeFutureCall(),
      'ConversationWorkerPollFutureCall': ConversationWorkerPollFutureCall(),
      'ModelCatalogSyncWorkerInvokeFutureCall':
          ModelCatalogSyncWorkerInvokeFutureCall(),
      'ModelCatalogSyncWorkerPollFutureCall':
          ModelCatalogSyncWorkerPollFutureCall(),
      'ObjectCleanupInvokeFutureCall': ObjectCleanupInvokeFutureCall(),
      'ObjectCleanupPollFutureCall': ObjectCleanupPollFutureCall(),
    };
...
class _FutureCallRef {
  ...
  late final conversationWorker = _ConversationWorkerFutureCallDispatcher(
    _invokeFutureCall,
  );

  late final modelCatalogSyncWorker =
      _ModelCatalogSyncWorkerFutureCallDispatcher(_invokeFutureCall);

  late final objectCleanup = _ObjectCleanupFutureCallDispatcher(
    _invokeFutureCall,
  );
}

class _ConversationWorkerFutureCallDispatcher {
  _ConversationWorkerFutureCallDispatcher(this._invokeFutureCall);
  ...
  Future<void> poll() {
    return _invokeFutureCall(
      'ConversationWorkerPollFutureCall',
      null,
    );
  }
}

class _ModelCatalogSyncWorkerFutureCallDispatcher {
  _ModelCatalogSyncWorkerFutureCallDispatcher(this._invokeFutureCall);
...
class _ObjectCleanupFutureCallDispatcher {
  _ObjectCleanupFutureCallDispatcher(this._invokeFutureCall);

  final _InvokeFutureCall _invokeFutureCall;

  Future<void> invoke(_i1.SerializableModel? object) {
    return _invokeFutureCall(
      'ObjectCleanupInvokeFutureCall',
      object,
    );
  }
  ...
  Future<void> poll() {
    return _invokeFutureCall(
      'ObjectCleanupPollFutureCall',
      null,
    );
  }
}

class ConversationWorkerInvokeFutureCall
  ...
  _i3.Future<void> invoke(
    ...
    await _i4.ConversationWorkerFutureCall().invoke(
      session,
      object,
    );
  }
...
class ConversationWorkerPollFutureCall extends _i1.FutureCall {
  @override
  _i3.Future<void> invoke(
    _i1.Session session,
    _i1.SerializableModel? object,
  ) async {
    await _i4.ConversationWorkerFutureCall().poll(session);
  }
}

class ModelCatalogSyncWorkerInvokeFutureCall
    extends _i1.FutureCall<_i1.SerializableModel> {
  @override
  _i3.Future<void> invoke(
    _i1.Session session,
    ...
    await _i5.ModelCatalogSyncWorkerFutureCall().invoke(
      session,
      object,
    );
  }
...
class ModelCatalogSyncWorkerPollFutureCall extends _i1.FutureCall {
  @override
  _i3.Future<void> invoke(
    _i1.Session session,
    _i1.SerializableModel? object,
  ) async {
    await _i5.ModelCatalogSyncWorkerFutureCall().poll(session);
  }
}

class ObjectCleanupInvokeFutureCall
    extends _i1.FutureCall<_i1.SerializableModel> {
  @override
  _i3.Future<void> invoke(
    _i1.Session session,
    ...
    await _i6.ObjectCleanupFutureCall().invoke(
      session,
      object,
    );
  }
...
class ObjectCleanupPollFutureCall extends _i1.FutureCall {
  @override
  _i3.Future<void> invoke(
    _i1.Session session,
    _i1.SerializableModel? object,
  ) async {
    await _i6.ObjectCleanupFutureCall().poll(session);
  }
}
