...
class OpenRouterPlugin extends GenkitPlugin {
  OpenRouterPlugin({
  ...
  final String _name;
  final String? apiKey;
  final OpenRouterApiKeyProvider? apiKeyProvider;
  final String baseUrl;
  final List<OpenRouterModelDefinition> models;
  ...
  Model<dynamic> _createModel(String modelName, ModelInfo? info) {
    return Model<dynamic>(
      ...
      fn: (req, ctx) async {
        ...
        final request = req;
        final options = OpenRouterOptions.fromJson(request.config);
  ...
  Future<ModelResponse> _stream(
    ...
    try {
      ...
      if (response.statusCode < 200 || response.statusCode >= 300) {
        ...
        throw GenkitException(
          'OpenRouter API error: $responseBody',
  ...
  Map<String, dynamic> _buildRequestBody({
    ...
    required OpenRouterOptions options,
