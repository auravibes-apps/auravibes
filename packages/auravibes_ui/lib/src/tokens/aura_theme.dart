...
class AuraColorScheme {
  ...
  AuraColorScheme._light()
    : primary = designColorPrimaryBase,
      primaryVariant = designColorPrimaryDark,
      onPrimary = designColorPrimaryContrast,
      secondary = designColorSecondaryBase,
      secondaryVariant = designColorSecondaryDark,
      onSecondary = designColorSecondaryContrast,
      surface = designColorNeutral50,
      surfaceVariant = const Color(0xFFFFFFFF),
      onSurface = designColorNeutral900,
      onSurfaceVariant = designColorNeutral700,
      background = designColorNeutral100,
      onBackground = designColorNeutral900,
      error = OKLCHColor(
        hue: hueError,
        lightness: 0.6,
        chroma: 0.2,
      ...
      outline = designColorNeutral300,
      outlineVariant = designColorNeutral200,
      shadow = designColorNeutral900,
      scrim = const Color(0x80000000);

  /// Creates a dark color scheme.
  AuraColorScheme._dark()
    : primary = designColorPrimaryLight,
      primaryVariant = designColorPrimaryBase,
      onPrimary = Colors.black,
      secondary = designColorSecondaryLight,
      secondaryVariant = designColorSecondaryBase,
      onSecondary = Colors.black,
      surface = designColorNeutral800,
      surfaceVariant = designColorNeutral700,
      onSurface = designColorNeutral100,
      onSurfaceVariant = designColorNeutral300,
      background = Colors.black,
      onBackground = designColorNeutral100,
      error = OKLCHColor(
        hue: hueError,
        lightness: 0.4,
        chroma: 0.2,
      ...
      onInfo = Colors.black,
      outline = designColorNeutral600,
      outlineVariant = designColorNeutral700,
