...
abstract final class ColorSpaceMatrices {
  ...
  static const lrgbToLms = MatrixTransformation(
    .new(0.41222147079999993, 0.5363325363, 0.0514459929),
    .new(0.2119034981999999, 0.6806995450999999, 0.1073969566),
    .new(0.08830246189999998, 0.2817188376, 0.6299787005000002),
  );

  /// Matrix transformation from LMS to linear RGB color space.
  static const lmsTolrgb = MatrixTransformation(
    .new(4.076741661347994, -3.307711590408193, 0.230969928729428),
    .new(-1.2684380040921763, 2.6097574006633715, -0.3413193963102197),
    .new(-0.004196086541837188, -0.7034186144594493, 1.7076147009309444),
  );
}
