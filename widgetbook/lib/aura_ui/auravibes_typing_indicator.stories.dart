...
part 'auravibes_typing_indicator.stories.bridge.g.dart';
...
const _meta = Meta(
  AuraTypingIndicator.new,
  argsType: _TypingIndicatorInput.new,
);

final _Defaults _typingIndicatorDefaults = _Defaults(
...
abstract final class _StorybookDefinitions {
  static final $DefaultTypingIndicator = _Story(
