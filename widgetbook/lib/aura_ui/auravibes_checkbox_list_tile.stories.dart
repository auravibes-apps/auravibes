...
part 'auravibes_checkbox_list_tile.stories.bridge.g.dart';
part 'auravibes_checkbox_list_tile.stories.g.dart';

const _component = ComponentMeta(name: 'AuraCheckboxListTile');
const _meta = Meta(CheckboxListTileDemo.new);

abstract final class _StorybookDefinitions {
  static final $CheckboxListTile = _Story(
