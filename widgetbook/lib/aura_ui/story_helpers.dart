...
abstract final class StoryHelpers {
  static const compactPhoneViewport = ViewportData(
    name: 'Compact Phone',
    width: 320,
    height: 568,
    pixelRatio: 1,
  ...
  static const landscapePhoneViewport = ViewportData(
  ...
  static const tabletViewport = ViewportData(
    name: 'Tablet',
    width: 768,
    height: 1024,
    pixelRatio: 1,
  ...
  static Widget constrainStoryWidth(Widget child, {double maxWidth = 420}) {
...
class AuraArabicLocaleMode() extends LocaleMode {
  this : super(const Locale('ar'), StoryHelpers.auraLocalizationDelegates);
}
...
class AuraDirectionalityMode(TextDirection value) extends Mode<TextDirection> {
  ...
  @override
  String get formattedValue => formatValue();

  String formatValue() => value == TextDirection.rtl ? 'RTL' : 'LTR';
}
