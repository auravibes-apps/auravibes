---
name: code-review
description: "Use for explicit requests to review changed code or a pull request, including requests to use CodeRabbit. Do not trigger for unrelated documentation or prompt audits."
metadata:
  version: "0.1.0"
---
