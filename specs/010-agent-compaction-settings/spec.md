...
- **FR-013**: The system MUST keep a recent uncompressed conversation tail after compaction so immediate context remains available.
...
- Default remaining-token threshold is configurable and uses a conservative default appropriate for the selected model context limit.
